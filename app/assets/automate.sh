...
#kmeans clustering
/home/newscontext/mahout/bin/mahout kmeans -i /home/newscontext/mahout/examples/bin/clus/files-sparse1/tfidf-vectors/ -c /home/newscontext/mahout/examples/bin/clus/initial-clusters1/clusters-*-final -o /home/newscontext/mahout/examples/bin/clus/kmeans1 -dm  org.apache.mahout.common.distance.TanimotoDistanceMeasure -cd 0.1 -x 15 -ow -cl -xm sequential
